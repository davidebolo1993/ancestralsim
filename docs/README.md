# AncestralSim Documentation

This directory contains focused notes for each part of the pipeline.

- [Inputs](inputs.md): region mapping files and PanSN haplotype FASTA format.
- [Core Simulation](simulation.md): endogenous haplotype selection, contamination, gargammel, trimming, and alignment.
